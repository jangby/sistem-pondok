    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="<?php echo e(route('pendidikan.admin.monitoring.ujian.input', ['mustawa' => $mustawa->id, 'mapel' => $mapel->id, 'jenis' => 'hafalan', 'semester' => $semester, 'tahun_ajaran' => $tahunAjaran])); ?>" 
                   class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition border-l-4 border-amber-500">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="text-2xl font-bold text-amber-600"><?php echo e($progress['hafalan'] ?? 0); ?>%</div>
                    </div>
