...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-16 h-16 fill-current text-emerald-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-16 h-16 fill-current text-emerald-600']); ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a class="text-sm font-medium text-emerald-600 hover:text-emerald-500" href="<?php echo e(route('password.request')); ?>">
                            Lupa Password?
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-xs text-gray-400">
                    &copy; <?php echo e(date('Y')); ?> Sistem Informasi Pondok Pesantren. <br>All rights reserved.
                </p>
            </div>
        </div>
    </div>j
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/auth/login.blade.php ENDPATH**/ ?>