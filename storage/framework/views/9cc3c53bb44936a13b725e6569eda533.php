                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 flex justify-between items-center">
                        <a href="<?php echo e(route('sekolah.admin.kelas.naikKelas.view')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            <?php echo e(__('Manajemen Naik Kelas')); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="<?php echo e(route('sekolah.admin.kelas.show', $kelas->id)); ?>" class="text-green-600 hover:text-green-900 mr-2">Lihat</a>
                                            <a href="<?php echo e(route('sekolah.admin.kelas.edit', $kelas->id)); ?>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                            
                                            <form action="<?php echo e(route('sekolah.admin.kelas.destroy', $kelas->id)); ?>" method="POST" class="inline-block ml-2" onsubmit="return confirm('Anda yakin ingin menghapus kelas ini?');">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/sekolah/admin/kelas/index.blade.php ENDPATH**/ ?>