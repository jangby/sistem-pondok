...
<div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
    ...
    <div class="flex items-center gap-3 w-full sm:w-auto">
        ...
        <a href="<?php echo e(route('sekolah.admin.jadwal-pelajaran.download-pdf')); ?>" target="_blank"
           class="w-full sm:w-auto inline-flex justify-center items-center px-5 py-2.5 bg-white hover:bg-red-50 text-gray-700 hover:text-red-600 text-sm font-semibold rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer group">
            <svg class="w-5 h-5 mr-2 text-red-500 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
