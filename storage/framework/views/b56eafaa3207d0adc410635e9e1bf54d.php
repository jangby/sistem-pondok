            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden report-card relative group" 
                    ...
                    <div class="p-8">
                        ...
                        <form action="<?php echo e(route('sekolah.admin.laporan.cetak')); ?>" method="POST" target="_blank" class="space-y-5">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-2 gap-4 pt-2">
                                <div>
                                    ...
                                    <select name="bulan" class="custom-select block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 font-semibold text-gray-700">
                                        <?php for($i=1; $i<=12; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php if($i == now()->month): echo 'selected'; endif; ?>><?php echo e(\Carbon\Carbon::create()->month($i)->locale('id')->isoFormat('MMMM')); ?></option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                                <div>
