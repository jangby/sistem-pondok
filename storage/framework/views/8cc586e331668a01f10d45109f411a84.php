    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <a href="<?php echo e(route('adminpondok.santri.export-pdf-mustawa')); ?>" target="_blank" class="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 px-4 rounded shadow-sm inline-flex items-center text-sm ml-2">
