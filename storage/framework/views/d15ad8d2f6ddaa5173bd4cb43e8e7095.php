    ...
    <div class="min-h-screen bg-gray-50 pb-32"
        ...
        <div class="bg-emerald-600 px-5 pt-8 pb-24 shadow-md rounded-b-[30px] relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center gap-3">
                <a href="<?php echo e(route('orangtua.dompet.index')); ?>" class="text-white hover:bg-emerald-700/50 p-2 rounded-full transition">
        ...
        <div class="px-5 -mt-16 relative z-20">
            <form method="POST" action="<?php echo e(route('orangtua.dompet.topup.store')); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <select name="dompet_id" class="block w-full pl-4 pr-10 py-3 border-gray-200 rounded-xl focus:ring-emerald-500 focus:border-emerald-500 text-gray-900 text-sm font-medium appearance-none" required>
                            <?php $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($santri->dompet): ?>
                                    <option value="<?php echo e($santri->dompet->id); ?>" <?php echo e(old('dompet_id', request('dompet_id')) == $santri->dompet->id ? 'selected' : ''); ?>>
                                        <?php echo e($santri->full_name); ?> (Saldo: Rp <?php echo e(number_format($santri->dompet->saldo, 0)); ?>)
                                    </option>
                                <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('nominal_topup'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('nominal_topup')),'class' => 'mt-2']); ?>
                ...
                <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 pb-6 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] z-50">
                    <div class="max-w-3xl mx-auto">
                        <div class="flex justify-between items-center mb-3 px-1">
                            ...
                            <span class="text-xs font-bold text-gray-700">Rp <?php echo e(number_format(5000, 0, ',', '.')); ?></span>
                        </div>
                        <button type="submit" 
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/orangtua/dompet/topup-create.blade.php ENDPATH**/ ?>