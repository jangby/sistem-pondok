...
<?php $component->withAttributes(['hide-nav' => true]); ?>
    ...
    <div class="min-h-screen bg-gray-900 font-sans relative overflow-hidden flex flex-col">
        ...
        <div class="absolute top-0 w-full z-20 p-4 flex justify-between items-center bg-gradient-to-b from-black/80 to-transparent">
            <a href="<?php echo e(route('pengurus.perpulangan.index')); ?>" class="text-white/80 hover:text-white p-2 bg-black/20 backdrop-blur rounded-full">
    ...
    <script>
        ...
        async function processScan(token) {
            ...
            try {
                const response = await fetch("<?php echo e(route('pengurus.perpulangan.scan.process')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pengurus/perpulangan/scan.blade.php ENDPATH**/ ?>