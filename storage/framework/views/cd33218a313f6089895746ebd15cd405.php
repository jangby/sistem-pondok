...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <span class="px-4 py-2 bg-white border border-gray-200 rounded-xl text-xs font-bold text-gray-500 shadow-sm">
                    Total Admin: <span class="text-blue-600 font-black text-sm ml-1"><?php echo e($users->total()); ?></span>
                </span>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
                                    ...
                                    <tr class="group hover:bg-blue-50/30 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-400">Terdaftar: <?php echo e($user->created_at->diffForHumans()); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <form action="<?php echo e(route('sekolah.superadmin.admin-sekolah.destroy', $user->id)); ?>" method="POST" class="delete-form">
                        ...
                        <div>
                            ...
                            <select name="sekolah_id" id="sekolah_id" required class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm py-2.5">
                                ...
                                <?php $__currentLoopData = $sekolahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sekolah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sekolah->id); ?>"><?php echo e($sekolah->nama_sekolah); ?> (<?php echo e($sekolah->tingkat); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
    ...
    <script>
        ...
        const baseUpdateUrl = "<?php echo e(url('sekolah-superadmin/admin-sekolah')); ?>"; 
        const storeUrl = "<?php echo e(route('sekolah.superadmin.admin-sekolah.store')); ?>";
        ...
        <?php if($errors->any()): ?>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('sekolah_id').value = "<?php echo e(old('sekolah_id')); ?>";
            });
        <?php endif; ?>
    </script>
    <?php $__env->stopPush(); ?>
