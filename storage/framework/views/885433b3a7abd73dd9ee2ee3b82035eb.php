        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1 font-medium">
                    Periode: <span class="text-emerald-600 font-bold uppercase"><?php echo e(\Carbon\Carbon::create()->month($bulan)->locale('id')->isoFormat('MMMM')); ?> <?php echo e($tahun); ?></span>
                </p>
            </div>
            
            
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('sekolah.admin.monitoring.siswa')); ?>" class="text-sm font-bold text-gray-500 hover:text-gray-800 transition mr-2">
                    &larr; Dashboard
                </a>
                ...
                <div class="flex flex-col md:flex-row justify-center items-end gap-6 px-2 mb-16">
                    ...
                    <div class="order-2 md:order-1 w-full md:w-1/3 card-winner">
                        <div class="bg-white rounded-3xl shadow-xl p-6 border-t-4 border-gray-300 flex flex-col items-center relative overflow-hidden">
                            ...
                            <h3 class="font-bold text-gray-800 text-lg text-center line-clamp-1 w-full"><?php echo e($laporan[1]->nama); ?></h3>
                            <p class="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-0.5 rounded-full mb-4 mt-1"><?php echo e($laporan[1]->kelas); ?></p>
                            
                            <div class="w-full text-center px-4">
                                <div class="text-4xl font-black text-gray-700"><?php echo e($laporan[1]->skor); ?><span class="text-lg text-gray-400">%</span></div>
                    ...
                    <div class="order-1 md:order-2 w-full md:w-1/3 card-winner z-20 -mt-10 md:-mt-0 transform md:-translate-y-6">
                        <div class="bg-academic rounded-3xl shadow-2xl shadow-emerald-900/30 p-8 border border-emerald-400/30 flex flex-col items-center relative overflow-hidden">
                            ...
                            <div class="relative z-10 text-center w-full text-white px-2">
                                <h3 class="font-black text-2xl line-clamp-1 w-full mb-1 tracking-tight"><?php echo e($laporan[0]->nama); ?></h3>
                                <p class="text-emerald-200 text-sm font-bold mb-6 tracking-wide bg-white/10 inline-block px-4 py-1 rounded-full backdrop-blur-sm">
                                    Kelas <?php echo e($laporan[0]->kelas); ?>

                                </p>
                                
                                <div class="bg-emerald-900/40 backdrop-blur-md rounded-2xl p-4 border border-emerald-400/20">
                                    <div class="flex items-end justify-center gap-1">
                                        <div class="text-6xl font-black text-gradient-gold drop-shadow-sm"><?php echo e($laporan[0]->skor); ?></div>
                                        <div class="text-xl font-bold text-emerald-200 mb-3">%</div>
                                    </div>
                                    <div class="w-full bg-white/10 rounded-full h-2 mt-2">
                                        <div class="bg-gradient-to-r from-yellow-300 to-yellow-500 h-2 rounded-full" style="width: <?php echo e($laporan[0]->skor); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="order-3 md:order-3 w-full md:w-1/3 card-winner">
                        <div class="bg-white rounded-3xl shadow-xl p-6 border-t-4 border-orange-300 flex flex-col items-center relative overflow-hidden">
                            ...
                            <h3 class="font-bold text-gray-800 text-lg text-center line-clamp-1 w-full"><?php echo e($laporan[2]->nama); ?></h3>
                            <p class="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-0.5 rounded-full mb-4 mt-1"><?php echo e($laporan[2]->kelas); ?></p>
                            
                            <div class="w-full text-center px-4">
                                <div class="text-4xl font-black text-gray-700"><?php echo e($laporan[2]->skor); ?><span class="text-lg text-gray-400">%</span></div>
                                <div class="text-[10px] text-gray-400 uppercase font-bold mt-1">Skor Disiplin</div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr class="hover:bg-emerald-50/40 transition-colors group">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div class="font-bold text-gray-800 text-sm group-hover:text-emerald-700 transition-colors"><?php echo e($row->nama); ?></div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 align-middle">
                                            <div class="flex flex-col gap-1.5 max-w-xs mx-auto">
                                                ...
                                                <div class="flex h-2.5 w-full rounded-full overflow-hidden bg-gray-100 shadow-inner ring-1 ring-gray-200/50">
                                                    ...
                                                    ?>
                                                    <div style="width: <?php echo e($pTepat); ?>%; background: #10b981;" title="Tepat Waktu"></div>
                                                    <div style="width: <?php echo e($pTelat); ?>%; background: #fbbf24;" title="Terlambat"></div>
                                                </div>
                                                
                                                <div class="flex justify-between text-[10px] font-bold uppercase text-gray-400 group-hover:text-gray-600 transition-colors">
                                                    <span class="text-emerald-600"><?php echo e($row->tepat_waktu); ?> Tepat</span>
                                                    <span class="text-amber-500"><?php echo e($row->terlambat); ?> Telat</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center justify-center px-4 py-1.5 rounded-xl font-black text-sm border <?php echo e($scoreClass); ?>">
                                                <?php echo e($row->skor); ?>%
                                            </span>
                                        </td>
                                    </tr>
            ...
            <?php else: ?>
                ...
                <div class="glass-panel rounded-3xl p-16 text-center flex flex-col items-center justify-center">
                    ...
                    <p class="text-gray-500 mt-2 max-w-md mx-auto text-sm leading-relaxed">
                        Tidak ada rekaman absensi yang ditemukan untuk periode bulan <strong class="text-emerald-600"><?php echo e(\Carbon\Carbon::create()->month($bulan)->locale('id')->isoFormat('MMMM')); ?></strong>.
                    </p>
                </div>
            <?php endif; ?>
