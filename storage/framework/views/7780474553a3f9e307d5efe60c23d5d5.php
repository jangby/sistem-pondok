...
<?php $component->withAttributes(['hide-nav' => true]); ?>
    ...
    <div class="min-h-screen bg-gray-50" style="padding-bottom: 180px;">
        ...
        <div class="fixed right-6 flex flex-col gap-3 z-50" style="bottom: 140px;">
            ...
            <a href="<?php echo e(route('pengurus.santri.create')); ?>" class="bg-emerald-600 text-white w-14 h-14 rounded-full shadow-xl shadow-emerald-300 flex items-center justify-center hover:bg-emerald-700 active:scale-90 transition" title="Tambah Manual">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <a href="<?php echo e(route('pengurus.santri.template')); ?>" class="flex items-center gap-3 p-3 bg-blue-50 text-blue-700 rounded-xl text-sm font-bold border border-blue-100 hover:bg-blue-100 transition">
                        ...
                        <form action="<?php echo e(route('pengurus.santri.import')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4 mt-4">
                            <?php echo csrf_field(); ?>
                            <div>
        ...
        <dialog id="exportModal" class="modal bg-transparent p-0 w-full h-full backdrop:bg-black/50">
            <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all">
                    ...
                    <form action="<?php echo e(route('pengurus.santri.export')); ?>" method="GET" class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <select name="kelas_id" class="w-full rounded-xl border-gray-300 focus:border-emerald-500 focus:ring-emerald-500">
                                ...
                                <?php $__currentLoopData = $kelas_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
