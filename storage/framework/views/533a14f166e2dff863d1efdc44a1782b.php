...
<body onload="window.print()">
    ...
    <div class="card-container">
        ...
        <div class="id-card">
            ...
            <img src="<?php echo e(asset('uploads/logos/logo-1-1762956082.jpg')); ?>" 
            ...
            <div class="card-body">
                <div class="name-section">
                    <div class="student-name"><?php echo e(Str::limit($santri->name, 20)); ?></div>
                </div>
            ...
            <div class="footer">
                ...
                <img class="barcode-img" 
                     src="https://bwipjs-api.metafloor.com/?bcid=code128&text=<?php echo e($santri->nis); ?>&scale=3&height=14&includetext&textxalign=center&textsize=10" 
