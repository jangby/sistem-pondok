...
<?php $component->withAttributes(['hide-nav' => true]); ?>
            ...
            <div class="max-w-3xl mx-auto px-4 py-3 flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-slate-500 font-medium mt-1 truncate max-w-[200px]">
                        <?php echo e($jadwal->mataPelajaran->nama_mapel ?? 'Mapel'); ?> &bull; <?php echo e($jadwal->kelas->nama_kelas ?? 'Kelas'); ?>
    ...
    <script>
        const ROUTE_PROSES = "<?php echo e(route('sekolah.guru.absensi_wajah.proses')); ?>";
        const CSRF_TOKEN = "<?php echo e(csrf_token()); ?>";
        const JADWAL_ID = "<?php echo e($jadwal->id); ?>";
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/sekolah/guru/absensi-wajah/scan.blade.php ENDPATH**/ ?>