...
<?php endif; ?>
                ...
                <a href="<?php echo e(route('sekolah.admin.monitoring.guru')); ?>" class="text-gray-600 hover:text-gray-900">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Ranking Kinerja Guru (Periode: <?php echo e(\Carbon\Carbon::create()->month($bulan)->format('F')); ?> <?php echo e($tahun); ?>)</h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $laporan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($index < 3 ? 'bg-yellow-50' : ''); ?>">
                                        <td class="px-4 py-3 whitespace-nowrap text-center font-bold text-gray-500">
                                            #<?php echo e($index + 1); ?>

                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($row->nama); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($row->nip); ?></div>
                                        </td>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-blue-600"><?php echo e($row->sakit + $row->izin); ?></td>
