...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Dashboard Pendidikan Pesantren (Madin)')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl mb-6 border border-emerald-100">
                <div class="p-6 text-gray-900 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-bold text-emerald-800">Ahlan wa Sahlan, <?php echo e(Auth::user()->name); ?>!</h3>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl border-l-4 border-blue-500 p-5">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($totalSantri ?? 0); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl border-l-4 border-emerald-500 p-5">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($totalUstadz ?? 0); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl border-l-4 border-amber-500 p-5">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($totalMustawa ?? 0); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-xl border-l-4 border-purple-500 p-5">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo e($totalJadwal ?? 0); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="<?php echo e(route('pendidikan.admin.mustawa.index')); ?>" class="block p-6 bg-white rounded-xl border border-gray-200 hover:shadow-md hover:border-emerald-300 transition group">
                ...
                <a href="<?php echo e(route('pendidikan.admin.mapel.index')); ?>" class="block p-6 bg-white rounded-xl border border-gray-200 hover:shadow-md hover:border-emerald-300 transition group">
                    <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-3 group-hover:bg-emerald-100 transition">
                ...
                <a href="<?php echo e(route('pendidikan.admin.ustadz.index')); ?>" class="block p-6 bg-white rounded-xl border border-gray-200 hover:shadow-md hover:border-emerald-300 transition group">
                    <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-3 group-hover:bg-emerald-100 transition">
                ...
                <a href="<?php echo e(route('pendidikan.admin.jadwal.index')); ?>" class="block p-6 bg-white rounded-xl border border-gray-200 hover:shadow-md hover:border-emerald-300 transition group">
                    <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-3 group-hover:bg-emerald-100 transition">
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pendidikan/admin/dashboard.blade.php ENDPATH**/ ?>