    ...
    <nav class="fixed w-full z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm transition-all duration-300">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center gap-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="px-5 py-2.5 text-sm font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-full border border-emerald-200 transition">Dashboard Sistem</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-slate-500 hover:text-slate-900 transition font-semibold text-sm">Masuk Portal</a>
                        <?php if(isset($ppdbActive) && $ppdbActive): ?>
                            <a href="<?php echo e(route('ppdb.register')); ?>" class="px-6 py-2.5 text-sm font-bold text-white bg-emerald-600 rounded-full hover:bg-emerald-700 shadow-lg shadow-emerald-600/30 transition transform hover:-translate-y-0.5">
                                Daftar Sekarang
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-slate-100 absolute w-full shadow-xl">
            <div class="px-4 pt-2 pb-6 space-y-2">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="block text-center px-3 py-3 text-base font-bold text-emerald-700 bg-emerald-50 rounded-lg">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block px-3 py-3 text-base font-medium text-slate-700 hover:bg-slate-50 rounded-lg">Masuk Portal</a>
                    <?php if(isset($ppdbActive) && $ppdbActive): ?>
                        <a href="<?php echo e(route('ppdb.register')); ?>" class="block mt-2 text-center px-3 py-3 text-base font-bold text-white bg-emerald-600 rounded-lg shadow-md">Daftar Santri Baru</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="text-center max-w-4xl mx-auto">
                ...
                <?php if(isset($ppdbActive) && $ppdbActive): ?>
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 mb-8 shadow-sm">
                        ...
                        <span class="text-sm font-bold tracking-wide">Penerimaan Santri Baru <?php echo e($ppdbActive->tahun_ajaran); ?> Dibuka</span>
                    </div>
                <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <?php if(isset($ppdbActive) && $ppdbActive): ?>
                        <a href="<?php echo e(route('ppdb.register')); ?>" class="px-8 py-4 text-lg font-bold text-white bg-emerald-600 rounded-xl hover:bg-emerald-700 shadow-xl shadow-emerald-600/30 transition transform hover:-translate-y-1">
                            Daftar Sekarang
                        </a>
                    <?php else: ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-6 text-slate-900">Informasi PPDB <br><span class="text-emerald-600">Gelombang <?php echo e($ppdbActive->nama_gelombang ?? 'Berjalan'); ?></span></h2>
                    ...
                    <div class="space-y-6 mt-8">
                        <div class="flex gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 mt-1">
                                    <?php echo e($ppdbActive->tanggal_mulai->translatedFormat('d F Y')); ?> <span class="font-medium">s/d</span> <?php echo e($ppdbActive->tanggal_akhir->translatedFormat('d F Y')); ?>
                        ...
                        <div class="flex gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-emerald-600 font-bold text-2xl mt-1">Rp <?php echo e(number_format($ppdbActive->biaya_pendaftaran, 0, ',', '.')); ?></p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 leading-relaxed">
                                    <?php echo e($ppdbActive->deskripsi ?? 'Pendaftaran dapat ditutup sewaktu-waktu jika kuota santri baru telah terpenuhi. Harap segera melengkapi berkas setelah melakukan pendaftaran akun.'); ?>
                ...
                <div class="relative bg-slate-900 rounded-3xl p-8 md:p-10 border border-slate-800 shadow-2xl">
                    ...
                    <div class="mt-10">
                        <a href="<?php echo e(route('ppdb.register')); ?>" class="flex justify-center items-center gap-2 w-full py-4 bg-emerald-500 hover:bg-emerald-400 rounded-xl font-bold text-slate-900 transition shadow-lg shadow-emerald-500/20">
                            Mulai Pendaftaran
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-slate-400 text-sm">
                        ...
                        <li><a href="<?php echo e(route('login')); ?>" class="hover:text-emerald-500 transition">Login Sistem</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-slate-500 text-sm">
                    &copy; <?php echo e(date('Y')); ?> Assa'adah Smart Digital. All rights reserved.
                </p>
