    ...
    <div class="min-h-screen bg-gray-50 pb-28">
        ...
        <div class="bg-blue-600 pt-8 pb-20 px-6 rounded-b-[35px] shadow-lg relative z-10">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('pengurus.absensi.index')); ?>" class="text-white/80 hover:text-white"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg></a>
            </div>
            
            
            <div class="grid grid-cols-2 gap-3 text-center">
                <div class="bg-white/20 backdrop-blur-md rounded-2xl p-3 border border-white/10">
                    <span class="block text-2xl font-black text-white"><?php echo e($totalDiluar); ?></span>
                ...
                <div class="bg-red-500/80 backdrop-blur-md rounded-2xl p-3 border border-white/10">
                    <span class="block text-2xl font-black text-white"><?php echo e($totalTerlambat); ?></span>
        ...
        <div class="px-5 -mt-6 relative z-20 mb-4">
            <a href="<?php echo e(route('pengurus.absensi.gerbang.settings')); ?>" class="flex items-center justify-between bg-white p-4 rounded-2xl shadow-md border border-gray-100 active:scale-95 transition">
        ...
        <div class="px-5 space-y-3">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $sedangDiluar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="bg-white p-4 rounded-2xl border <?php echo e($isLate ? 'border-red-200 bg-red-50/30' : 'border-gray-100'); ?> shadow-sm flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center font-bold text-xs text-gray-600">
                            <?php echo e(substr($log->santri->full_name, 0, 1)); ?>

                        </div>
                        <div>
                            <h3 class="font-bold text-gray-800 text-sm"><?php echo e($log->santri->full_name); ?></h3>
                            <p class="text-[10px] text-gray-500">Keluar: <?php echo e($log->out_time->format('H:i')); ?></p>
                        </div>
                    </div>
                    
                    <div class="text-right">
                        <span class="block text-lg font-black <?php echo e($isLate ? 'text-red-600' : 'text-blue-600'); ?>">
                            <?php echo e($durasiTampil); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pengurus/absensi/gerbang/index.blade.php ENDPATH**/ ?>