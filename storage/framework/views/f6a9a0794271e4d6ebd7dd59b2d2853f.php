...
<?php $component->withAttributes(['hide-nav' => true]); ?>
    ...
    <div class="min-h-screen bg-gray-50 pb-32"
         x-data="{
            sisaTagihan: <?php echo e($sisaTagihan); ?>,
            nominalBayar: <?php echo e($sisaTagihan); ?>, // Default lunas
            biayaAdmin: 5000,
        ...
        <div class="bg-emerald-600 px-5 pt-8 pb-24 shadow-md rounded-b-[30px] relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center gap-3">
                <a href="<?php echo e(route('orangtua.tagihan.show', $tagihan->id)); ?>" class="text-white hover:bg-emerald-700/50 p-2 rounded-full transition">
        ...
        <div class="px-5 -mt-16 relative z-20">
            <form method="POST" action="<?php echo e(route('orangtua.tagihan.proses-pembayaran', $tagihan->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                    <div class="p-6 text-center border-b border-gray-50">
                        ...
                        <p class="text-[10px] text-gray-400 mt-1 uppercase font-medium tracking-wide">+ Biaya Admin Rp <?php echo e(number_format(5000, 0, ',', '.')); ?></p>
                    </div>
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
                        <div class="flex justify-between text-sm mb-1">
                            <span class="text-gray-500">Tagihan</span>
                            <span class="font-medium text-gray-900 truncate max-w-[150px]"><?php echo e($tagihan->jenisPembayaran->name); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500">Sisa Tagihan</span>
                            <span class="font-bold text-red-500">Rp <?php echo e(number_format($sisaTagihan, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('nominal_bayar'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('nominal_bayar')),'class' => 'mt-2']); ?>
...
<?php endif; ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                    ...
                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('payment_method'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('payment_method')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/orangtua/payment/pilih-metode.blade.php ENDPATH**/ ?>