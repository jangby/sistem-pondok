...
<?php $__env->startSection('title', 'Informasi PPDB & Pendaftaran'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-32 pb-20 text-center">
            ...
            <a href="<?php echo e(route('ppdb.register')); ?>" class="inline-flex items-center gap-2 px-8 py-4 text-base font-bold text-slate-900 bg-white rounded-full hover:bg-slate-100 shadow-[0_0_40px_rgba(16,185,129,0.3)] transition transform hover:-translate-y-1">
                    ...
                    <div class="bg-slate-900 rounded-[2rem] p-8 md:p-10 shadow-2xl border border-slate-800 relative overflow-hidden">
                        ...
                        <div class="flex items-baseline gap-2 mb-8">
                            ...
                            <?php if(isset($ppdbActive) && $ppdbActive): ?>
                                <span class="text-5xl font-black text-white tracking-tight"><?php echo e(number_format($ppdbActive->biaya_pendaftaran, 0, ',', '.')); ?></span>
                            <?php else: ?>
    ...
    <section class="py-20 bg-emerald-600 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('ppdb.register')); ?>" class="px-8 py-4 bg-white text-emerald-700 font-bold text-lg rounded-full shadow-xl hover:bg-slate-50 hover:scale-105 transition-transform duration-300">
                    Mulai Pendaftaran
                </a>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/landing/ppdb.blade.php ENDPATH**/ ?>