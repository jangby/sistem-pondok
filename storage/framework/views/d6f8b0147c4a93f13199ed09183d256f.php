            ...
            <div class="flex items-center justify-between py-3">
                ...
                <div class="flex justify-center w-full md:w-2/4">
                    <div class="bg-gray-100 p-1 rounded-xl inline-flex shadow-inner">
                        ...
                        <a href="<?php echo e(route('sekolah.admin.monitoring.siswa')); ?>" class="px-6 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-200 rounded-lg transition-all">
                            Monitoring Siswa
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 text-center">
                        ...
                        <p class="text-sm text-gray-600 mt-2">
                            ...
                            <?php else: ?>
                                Hari ini (<?php echo e($namaHariIni); ?>) bukan hari kerja.
                            <?php endif; ?>
                        </p>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div class="grid grid-cols-2 md:grid-cols-5 gap-6 mb-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm">
                        ...
                        <p class="text-3xl font-bold text-indigo-600 mt-1"><?php echo e($kpi_jam_kosong); ?></p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">
                                Guru Belum Hadir (<?php echo e(count($daftarBelumHadir)); ?>)
                            </h3>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__empty_1 = true; $__currentLoopData = $daftarBelumHadir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    <p class="text-sm font-medium text-gray-900"><?php echo e($guru->name ?? $guru->guru->name); ?></p>
                                                    <p class="text-xs text-gray-500"><?php echo e($guru->email ?? $guru->guru->email); ?></p>
                                                </td>
                                                <td class="px-4 py-3 whitespace-nowrap text-sm">
                                                    <?php if($guru instanceof \App\Models\Sekolah\AbsensiGuru && $guru->status == 'sakit'): ?>
                                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Sakit</span>
                                                    <?php elseif($guru instanceof \App\Models\Sekolah\AbsensiGuru && $guru->status == 'izin'): ?>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">
                                Guru Sudah Hadir (<?php echo e(count($daftarHadir)); ?>)
                            </h3>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__empty_1 = true; $__currentLoopData = $daftarHadir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    <p class="text-sm font-medium text-gray-900"><?php echo e($absensi->guru->name); ?></p>
                                                </td>
                                                <td class="px-4 py-3 whitespace-nowrap">
                                                    <p class="text-sm text-gray-500"><?php echo e($absensi->jam_masuk); ?></p>
                                                </td>
                                                <td class="px-4 py-3 whitespace-nowrap text-sm">
                                                    <?php if($absensi->jam_masuk > $settings->batas_telat): ?>
