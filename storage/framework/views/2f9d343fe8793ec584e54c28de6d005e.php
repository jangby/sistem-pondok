...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Buat Desain Rapor Baru')); ?>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <form action="<?php echo e(route('pendidikan.admin.rapor-template.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pendidikan/admin/rapor/template/create.blade.php ENDPATH**/ ?>