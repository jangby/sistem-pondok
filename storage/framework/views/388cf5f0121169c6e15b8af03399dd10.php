...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <?php if($tahunAjaranAktif): ?>
                <div class="hidden md:flex items-center gap-3 text-sm text-gray-600 bg-white px-4 py-2 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <span>Tahun Ajaran: <span class="font-bold text-gray-900"><?php echo e($tahunAjaranAktif->nama_tahun_ajaran); ?></span></span>
                </div>
            <?php endif; ?>
        </div>
     <?php $__env->endSlot(); ?>
                                    ...
                                    <tr class="group hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-start gap-3">
                                                <div class="flex-shrink-0 mt-1">
                                                     <span class="px-2 py-1 text-[10px] font-bold uppercase rounded-md border <?php echo e($tipeClass); ?>">
                                                        <?php echo e($kegiatan->tipe); ?>

                                                     </span>
                                                </div>
                                                <div>
                                                    <div class="text-sm font-bold text-gray-900"><?php echo e($kegiatan->nama_kegiatan); ?></div>
                                                    <?php if($kegiatan->keterangan): ?>
                                                        <div class="text-xs text-gray-500 mt-0.5 line-clamp-1"><?php echo e($kegiatan->keterangan); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex flex-col gap-1.5">
                                                <div class="flex items-center text-sm text-gray-600 font-medium">
                                                    ...
                                                    <?php echo e($tglMulai->format('d M')); ?> - <?php echo e($tglSelesai->format('d M Y')); ?>

                                                </div>
                                                <div class="flex">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border <?php echo e($statusClass); ?>">
                                                        <span class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($dotClass); ?>"></span>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end gap-3">
                                                ...
                                                <a href="<?php echo e(route('sekolah.admin.kegiatan-akademik.kelola.kelas', $kegiatan->id)); ?>" 
                                                ...
                                                <button onclick="openModal('edit', <?php echo e($kegiatan); ?>)" class="text-gray-400 hover:text-amber-500 transition" title="Edit">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                                </button>

                                                
                                                <form action="<?php echo e(route('sekolah.admin.kegiatan-akademik.destroy', $kegiatan->id)); ?>" method="POST" class="delete-form">
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            const baseUpdateUrl = "<?php echo e(route('sekolah.admin.kegiatan-akademik.index')); ?>";
            const storeUrl = "<?php echo e(route('sekolah.admin.kegiatan-akademik.store')); ?>";
            ...
            <?php if($errors->any()): ?>
                document.addEventListener('DOMContentLoaded', function() {
                    openModal('create');
                    document.getElementById('nama_kegiatan').value = "<?php echo e(old('nama_kegiatan')); ?>";
                    document.getElementById('tipe').value = "<?php echo e(old('tipe')); ?>";
                    ...
                    document.getElementById('keterangan').value = "<?php echo e(old('keterangan')); ?>";
                });
            <?php endif; ?>
