        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <div class="flex items-center gap-2 text-sm text-gray-500 mb-1">
                    <a href="<?php echo e(route('sekolah.admin.kegiatan-akademik.kelola.kelas', $kegiatan->id)); ?>" class="hover:text-indigo-600 transition">Kelas <?php echo e($kelas->nama_kelas); ?></a>
                    <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                    <a href="<?php echo e(route('sekolah.admin.kegiatan-akademik.kelola.mapel', ['kegiatan' => $kegiatan->id, 'kelas' => $kelas->id])); ?>" class="hover:text-indigo-600 transition">Mapel</a>
                    <svg class="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                    <span>Nilai</span>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-indigo-100 relative overflow-hidden">
                    ...
                    <div class="text-2xl font-black text-gray-900"><?php echo e($mapel->nama_mapel); ?></div>
                    <div class="text-sm text-gray-500 mt-1 font-mono"><?php echo e($mapel->kode_mapel ?? '-'); ?></div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex items-end gap-2">
                            <div class="text-3xl font-black text-gray-800"><?php echo e($persenSelesai); ?><span class="text-lg text-gray-400">%</span></div>
                            <div class="text-sm text-gray-500 mb-1.5"><?php echo e($countTerisi); ?> dari <?php echo e($countTotal); ?> Siswa</div>
                        </div>
                    </div>
                    <div class="w-full bg-gray-100 rounded-full h-2 mt-3">
                        <div class="bg-indigo-600 h-2 rounded-full transition-all duration-1000" style="width: <?php echo e($persenSelesai); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-center">
                        <div class="p-2 bg-emerald-50 rounded-lg border border-emerald-100">
                            ...
                            <div class="text-lg font-black text-emerald-700"><?php echo e($rataRata); ?></div>
                        </div>
                        <div class="p-2 bg-blue-50 rounded-lg border border-blue-100">
                            ...
                            <div class="text-lg font-black text-blue-700"><?php echo e($tertinggi); ?></div>
                        </div>
                        <div class="p-2 bg-rose-50 rounded-lg border border-rose-100">
                            ...
                            <div class="text-lg font-black text-rose-700"><?php echo e($terendah); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex gap-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
                    ...
                    <div class="flex bg-white rounded-xl shadow-sm border border-gray-200 p-1">
                        <a href="<?php echo e(route('sekolah.admin.kegiatan-akademik.cetak.daftar-hadir', ['kegiatan' => $kegiatan->id, 'kelas' => $kelas->id, 'mapel' => $mapel->id])); ?>" target="_blank" class="px-3 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                            Absensi
                        </a>
                        <div class="w-px bg-gray-200 my-1"></div>
                        <a href="<?php echo e(route('sekolah.admin.kegiatan-akademik.cetak.format-nilai', ['kegiatan' => $kegiatan->id, 'kelas' => $kelas->id, 'mapel' => $mapel->id])); ?>" target="_blank" class="px-3 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg transition flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                            Format
                        </a>
                        <div class="w-px bg-gray-200 my-1"></div>
                        <a href="<?php echo e(route('sekolah.admin.kegiatan-akademik.cetak.nilai', ['kegiatan' => $kegiatan->id, 'kelas' => $kelas->id, 'mapel' => $mapel->id])); ?>" target="_blank" class="px-3 py-1.5 text-xs font-bold text-indigo-600 hover:bg-indigo-50 rounded-lg transition flex items-center gap-1">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="group hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500"><?php echo e($index + 1); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-9 w-9 rounded-full <?php echo e($avatarColor); ?> flex items-center justify-center text-xs font-bold border border-white shadow-sm">
                                                <?php echo e($initials); ?>

                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-bold text-gray-900"><?php echo e($santri->full_name); ?></div>
                                                <div class="text-xs text-gray-500 font-mono"><?php echo e($santri->nis); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="inline-flex items-center justify-center w-16 h-10 rounded-lg border <?php echo e($bgNilai); ?>">
                                            <span class="text-lg font-black <?php echo e($nilaiClass); ?>">
                                                <?php echo e($isMissing ? '-' : number_format($nilai, 0)); ?>
