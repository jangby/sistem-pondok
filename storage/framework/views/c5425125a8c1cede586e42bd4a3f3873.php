     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('pendidikan.admin.rapor.export_biodata')); ?>" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium px-4 py-2 rounded-md shadow-sm transition duration-150 ease-in-out">
                    <i class="fa fa-file-excel"></i> 
                    <span>Download Biodata Rapor</span>
                </a>
                
                <a href="<?php echo e(route('pendidikan.admin.rapor.export_nilai', ['jenis_ujian' => 'uas', 'semester' => 'genap'])); ?>" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-md shadow-sm transition duration-150 ease-in-out">
                    <i class="fa fa-file-excel"></i> 
                    <span>Download Nilai (UAS Genap)</span>
                </a>

                <a href="<?php echo e(route('pendidikan.admin.rapor.export_lengkap', ['jenis_ujian' => 'uas', 'semester' => 'genap'])); ?>" class="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-gray-900 text-sm font-bold px-4 py-2 rounded-md shadow-sm transition duration-150 ease-in-out">
                    <i class="fa fa-file-excel"></i> 
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex justify-between items-center mb-6 border-b pb-4">
                    ...
                    <a href="<?php echo e(route('pendidikan.admin.rapor-template.index')); ?>" class="text-sm text-blue-600 hover:underline flex items-center gap-1">
                        ...
                        <div>
                            ...
                            <?php if($templates->isEmpty()): ?>
                                <p class="text-xs text-red-500 mt-1">
                                    Belum ada desain. 
                                    <a href="<?php echo e(route('pendidikan.admin.rapor-template.create')); ?>" class="underline font-bold text-red-600 hover:text-red-700">Buat dulu di sini.</a>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
