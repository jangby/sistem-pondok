...
<?php $component->withAttributes(['hide-nav' => true]); ?>
    ...
    <div x-data="absensiSystem(<?php echo e($santris); ?>)" class="min-h-screen bg-gray-50 flex flex-col">
        
        
        <div class="bg-white shadow-sm sticky top-0 z-40">
            <div class="bg-emerald-600 px-4 py-4 pb-8 rounded-b-[25px]">
                <div class="flex justify-between items-center text-white">
                    <a href="<?php echo e(route('ustadz.absensi.menu', $jadwal->id)); ?>" class="flex items-center gap-2 hover:text-emerald-200 transition">
        ...
        <div class="fixed bottom-0 w-full max-w-md bg-white border-t border-gray-200 p-4 z-50">
            <form method="POST" action="<?php echo e(route('ustadz.absensi.store', $jadwal->id)); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pendidikan/ustadz/absensi/create.blade.php ENDPATH**/ ?>