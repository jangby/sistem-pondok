...
<?php $component->withAttributes(['hide-nav' => true]); ?>
            ...
            <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl shadow-emerald-900/10 border border-white/50 p-4">
                <div class="flex justify-between items-center divide-x divide-gray-100">
                    ...
                    <div class="flex-1 text-center px-1">
                        <span class="block text-xl font-black text-gray-800"><?php echo e($sakitHariIni ?? 0); ?></span>
                        <span class="text-[10px] text-gray-500 font-semibold uppercase tracking-wide">Sakit</span>
                    </div>

                    
                    <div class="flex-1 text-center px-1">
                        <span class="block text-xl font-black text-gray-800"><?php echo e($izinKeluarAktif ?? 0); ?></span>
                        <span class="text-[10px] text-gray-500 font-semibold uppercase tracking-wide">Izin</span>
                    </div>

                    
                    <div class="flex-1 text-center px-1">
                        <span class="block text-xl font-black text-gray-800"><?php echo e($hadirHariIni ?? 0); ?></span>
        ...
        <div class="px-5 mt-6">
            <div class="bg-white rounded-2xl p-5 shadow-lg shadow-emerald-900/5 border border-white">
                ...
                <div class="grid grid-cols-4 gap-y-6 gap-x-2">
                    ...
                    <a href="<?php echo e(route('pengurus.uks.index')); ?>" class="flex flex-col items-center gap-2 group">
                    ...
                    <a href="<?php echo e(route('pengurus.perizinan.index')); ?>" class="flex flex-col items-center gap-2 group">
                    ...
                    <a href="<?php echo e(route('pengurus.absensi.index')); ?>" class="flex flex-col items-center gap-2 group">
                    ...
                    <a href="<?php echo e(route('pengurus.santri.index')); ?>" class="flex flex-col items-center gap-2 group">
                    ...
                    <a href="<?php echo e(route('pengurus.inventaris.index')); ?>" class="flex flex-col items-center gap-2 group">
                     ...
                     <a href="<?php echo e(route('pengurus.asrama.index')); ?>" class="flex flex-col items-center gap-2 group">
                    ...
                    <a href="<?php echo e(route('pengurus.perpulangan.index')); ?>" class="flex flex-col items-center gap-2 group">
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-200 pb-safe pt-2 px-6 shadow-[0_-5px_20px_-5px_rgba(0,0,0,0.1)] z-50">
        <div class="flex justify-around items-end pb-3">
            ...
            <a href="<?php echo e(route('pengurus.dashboard')); ?>" class="flex flex-col items-center gap-1 group">
            ...
            <a href="<?php echo e(route('profile.edit')); ?>" class="flex flex-col items-center gap-1 group text-gray-400 hover:text-emerald-600 transition">
                <div class="p-1.5">
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pengurus/dashboard.blade.php ENDPATH**/ ?>