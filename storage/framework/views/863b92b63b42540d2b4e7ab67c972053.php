...
<?php $component->withAttributes(['hide-nav' => true]); ?>
    ...
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        <div class="px-5 -mt-12 relative z-20">
            ...
            <a href="<?php echo e(route('pengurus.absensi.gerbang')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition">
            ...
            <a href="<?php echo e(route('pengurus.jadwal.index')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition relative overflow-hidden">
                <div class="absolute top-0 right-0 w-2 h-full bg-indigo-500"></div>
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition duration-300">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    </div>
                    <div class="flex-1">
                        <h3 class="text-lg font-bold text-gray-800 group-hover:text-indigo-600 transition">Jadwal Jaga Gerbang</h3>
                        <p class="text-xs text-gray-500 mt-1">Atur jadwal & PIN santri bertugas</p>
                    </div>
            ...
            <a href="<?php echo e(route('pengurus.buku-tamu.index')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition relative overflow-hidden">
            ...
            <a href="<?php echo e(route('pengurus.absensi.asrama')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition">
                <div class="flex items-center gap-4">
            ...
            <a href="<?php echo e(route('pengurus.absensi.kegiatan')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition">
                <div class="flex items-center gap-4">
            ...
            <a href="<?php echo e(route('pengurus.absensi.jamaah')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition">
                <div class="flex items-center gap-4">
            ...
            <a href="<?php echo e(route('pengurus.absensi.kontrol')); ?>" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition">
                <div class="flex items-center gap-4">
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pengurus/absensi/index.blade.php ENDPATH**/ ?>