    ...
    <div class="min-h-screen bg-gray-50 pb-20 font-sans">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div class="flex justify-between items-center text-center divide-x divide-gray-100">
                    <div class="px-2 w-1/3">
                        <span class="block text-2xl font-bold text-orange-500"><?php echo e($peminjamanAktif ?? 0); ?></span>
                        <span class="text-[10px] text-gray-400 font-bold uppercase tracking-wide">Dipinjam</span>
                    </div>
                    <div class="px-2 w-1/3">
                        <span class="block text-2xl font-bold text-emerald-600"><?php echo e($kunjunganHariIni ?? 0); ?></span>
                        <span class="text-[10px] text-gray-400 font-bold uppercase tracking-wide">Tamu Harian</span>
                    </div>
                    <div class="px-2 w-1/3">
                        <span class="block text-2xl font-bold text-blue-600"><?php echo e($totalBuku ?? 0); ?></span>
        ...
        <div class="px-6 mt-8">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <a href="<?php echo e(route('sekolah.petugas.sirkulasi.index')); ?>" class="flex flex-col items-center gap-2 group">
                ...
                <a href="<?php echo e(route('sekolah.petugas.buku.index')); ?>" class="flex flex-col items-center gap-2 group">
                ...
                <a href="<?php echo e(route('sekolah.petugas.kunjungan.index')); ?>" class="flex flex-col items-center gap-2 group">
                ...
                <a href="<?php echo e(route('sekolah.petugas.audit.index')); ?>" class="flex flex-col items-center gap-2 group">
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/sekolah/petugas/dashboard.blade.php ENDPATH**/ ?>