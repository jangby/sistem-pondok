...
<div class="p-6 text-gray-900">
    <div class="mb-4">
        <a href="<?php echo e(route('sekolah.superadmin.persetujuan-izin.index', ['status' => 'pending'])); ?>" class="<?php echo e($status == 'pending' ? 'font-bold text-blue-600' : 'text-gray-500'); ?>">Pending</a> |
        <a href="<?php echo e(route('sekolah.superadmin.persetujuan-izin.index', ['status' => 'approved'])); ?>" class="<?php echo e($status == 'approved' ? 'font-bold text-green-600' : 'text-gray-500'); ?>">Disetujui</a> |
        <a href="<?php echo e(route('sekolah.superadmin.persetujuan-izin.index', ['status' => 'rejected'])); ?>" class="<?php echo e($status == 'rejected' ? 'font-bold text-red-600' : 'text-gray-500'); ?>">Ditolak</a>
    </div>
    ...
    <tr>
        ...
        <td class="px-4 py-3 text-sm">
            <?php if($status == 'pending'): ?>
            <form method="POST" action="<?php echo e(route('sekolah.superadmin.persetujuan-izin.reject', $izin->id)); ?>" onsubmit="return confirm('Tolak pengajuan ini?');" class="mb-2">
                <?php echo csrf_field(); ?>
            ...
            <form method="POST" action="<?php echo e(route('sekolah.superadmin.persetujuan-izin.approve', $izin->id)); ?>" onsubmit="return confirm('Setujui pengajuan ini?');">
                <?php echo csrf_field(); ?>
