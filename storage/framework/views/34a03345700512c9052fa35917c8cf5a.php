    ...
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        <div class="px-5 -mt-12 relative z-20">
            <div class="bg-white rounded-3xl shadow-lg border border-gray-100 p-5">
                ...
                <h2 class="text-3xl font-black text-emerald-600 mb-4">Rp <?php echo e(number_format($nilaiAset, 0, ',', '.')); ?></h2>
                
                <div class="grid grid-cols-3 gap-2 border-t border-gray-100 pt-4 text-center">
                    <div>
                        <span class="block text-lg font-bold text-gray-800"><?php echo e($totalAset); ?></span>
                        <span class="text-[10px] text-gray-400 uppercase">Total Item</span>
                    </div>
                    <div>
                        <span class="block text-lg font-bold text-red-500"><?php echo e($totalRusak); ?></span>
                        <span class="text-[10px] text-gray-400 uppercase">Rusak</span>
                    </div>
                    <div>
                        <span class="block text-lg font-bold text-blue-500"><?php echo e($totalPinjam); ?></span>
        ...
        <div class="px-5 mt-8">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="<?php echo e(route('pengurus.inventaris.barang.index')); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 active:scale-95 transition group">
                ...
                <a href="<?php echo e(route('pengurus.inventaris.lokasi.index')); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 active:scale-95 transition group">
                ...
                <a href="<?php echo e(route('pengurus.inventaris.kerusakan.index')); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 active:scale-95 transition group">
                ...
                <a href="<?php echo e(route('pengurus.inventaris.peminjaman.index')); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 active:scale-95 transition group">
                ...
                <a href="<?php echo e(route('pengurus.inventaris.rekap.index')); ?>" class="col-span-2 bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 active:scale-95 transition group flex items-center gap-4">
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/pengurus/inventaris/dashboard.blade.php ENDPATH**/ ?>