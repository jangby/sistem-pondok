    ...
    <div class="min-h-screen bg-gray-50 pb-20">
        ...
        <div class="bg-emerald-600 pt-8 pb-24 px-6 rounded-b-[35px] shadow-lg relative overflow-hidden z-10">
            ...
            <div class="relative z-10 flex justify-between items-center mb-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg font-bold text-white leading-tight"><?php echo e($santri->full_name); ?></h1>
                        <p class="text-[10px] text-emerald-100"><?php echo e($santri->mustawa->nama ?? 'Santri Aktif'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center text-white mt-2">
                ...
                <div class="inline-flex items-center gap-2 <?php echo e($status['class']); ?> pl-1.5 pr-4 py-1.5 rounded-full shadow-lg shadow-black/10 border border-white/20">
                    <div class="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center">
                        
                        <?php if($status['icon'] == 'home'): ?>
                        ...
                        <?php elseif($status['icon'] == 'logout'): ?>
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                        <?php elseif($status['icon'] == 'heart'): ?>
                ...
                <p class="text-[10px] mt-2 text-emerald-50 opacity-90 italic">"<?php echo e($status['desc']); ?>"</p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-5 border border-gray-100 flex items-center justify-between">
                ...
                <?php if($lastActivity): ?>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 <?php echo e($badgeColor); ?> rounded-2xl flex items-center justify-center shrink-0">
                        ...
                        <div>
                            ...
                            <h3 class="font-bold text-gray-800 text-sm line-clamp-1"><?php echo e($lastActivity->nama_kegiatan ?? 'Absensi Harian'); ?></h3>
                            <p class="text-xs text-gray-500">
                                <?php echo e(\Carbon\Carbon::parse($lastActivity->waktu_catat)->diffForHumans()); ?>

                            </p>
                        </div>
                    </div>
                    <div class="text-right">
                        <span class="text-[10px] <?php echo e($badgeColor); ?> px-2 py-1 rounded-lg font-bold block">
                            <?php echo e($statusLabel); ?>

                        </span>
                        <span class="text-[10px] text-gray-400 mt-1 block">
                            <?php echo e(\Carbon\Carbon::parse($lastActivity->waktu_catat)->format('H:i')); ?>
        ...
        <div class="px-5 space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="<?php echo e(route('orangtua.monitoring.diniyah', $santri->id)); ?>" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition hover:border-teal-300 group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('orangtua.monitoring.hafalan', $santri->id)); ?>" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition hover:border-amber-300 group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('orangtua.monitoring.absensi', $santri->id)); ?>" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition hover:border-blue-300">
                ...
                <a href="<?php echo e(route('orangtua.monitoring.kesehatan', $santri->id)); ?>" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition hover:border-red-300">
                ...
                <a href="<?php echo e(route('orangtua.monitoring.izin', $santri->id)); ?>" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition hover:border-purple-300">
                ...
                <a href="<?php echo e(route('orangtua.monitoring.gerbang', $santri->id)); ?>" class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 active:scale-95 transition hover:border-orange-300">
