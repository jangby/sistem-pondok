        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100 relative">
                <div class="p-6 sm:p-8 flex justify-between items-center relative z-10">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Ahlan Wa Sahlan, <?php echo e(Auth::user()->name); ?>!</h2>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="mt-2">
                            <h3 class="text-3xl font-bold text-emerald-600">
                                Rp <?php echo e(number_format($pemasukanBulanIni, 0, ',', '.')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-full">
                        ...
                        <div class="space-y-3">
                            <a href="<?php echo e(route('adminpondok.tagihan.create')); ?>" class="group flex items-center justify-between p-4 bg-emerald-50 border border-emerald-100 rounded-lg hover:bg-emerald-100 hover:border-emerald-200 transition">
                            ...
                            <a href="<?php echo e(route('adminpondok.santris.create')); ?>" class="group flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg hover:border-emerald-300 hover:shadow-sm transition">
                                <div class="flex items-center gap-3">
                            ...
                            <a href="<?php echo e(route('adminpondok.orang-tuas.create')); ?>" class="group flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg hover:border-emerald-300 hover:shadow-sm transition">
                                <div class="flex items-center gap-3">
                                    <div class="p-2 bg-gray-50 rounded-full text-gray-600 group-hover:bg-emerald-50 group-hover:text-emerald-600">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden h-full">
                        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                            ...
                            <a href="<?php echo e(route('adminpondok.buku-besar.index')); ?>" class="text-sm text-emerald-600 hover:text-emerald-700 font-medium">Lihat Semua &rarr;</a>
                        </div>
                                ...
                                <div class="p-4 hover:bg-gray-50 transition flex items-center justify-between">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p class="font-semibold text-gray-900">
                                                Rp <?php echo e(number_format($payment->total_bayar, 0, ',', '.')); ?>

                                            </p>
                                            <p class="text-sm text-gray-500">
                                                <?php echo e($payment->tagihan->santri->full_name ?? ($payment->orangTua->name ?? 'N/A')); ?>
                                    ...
                                    <div class="text-right">
                                        <span class="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-600 capitalize">
                                            <?php echo e(str_replace('_', ' ', $payment->metode_pembayaran)); ?>

                                        </span>
                                        <p class="text-xs text-gray-400 mt-1">
                                            <?php echo e($payment->tanggal_bayar->diffForHumans()); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/adminpondok/dashboard.blade.php ENDPATH**/ ?>