                        ...
                        <table class="min-w-full divide-y divide-gray-100">
                            <thead class="bg-gray-50/80">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">KKM</th> <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Kode Sistem</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                <?php $__currentLoopData = $mataPelajarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="group hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-bold text-gray-900"><?php echo e($mapel->kkm); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
...
unset($__errorArgs, $__bag); ?></p>
                        ...
                        <div>
    <label for="kkm" class="block text-sm font-medium text-gray-700 mb-1">Nilai KKM</label>
    <input type="number" name="kkm" id="kkm" required min="0" max="100" placeholder="Cth: 75"
           class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5"
           value="<?php echo e(old('kkm', 70)); ?>">
    <p class="mt-1 text-xs text-red-500"><?php $__errorArgs = ['kkm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
        ...
        <script>
            ...
            function openModal(mode, data = null) {
                ...
                if (mode === 'create') {
                    ...
                    document.getElementById('kkm').value = "70";
