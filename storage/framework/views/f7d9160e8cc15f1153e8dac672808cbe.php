...
<?php $component->withAttributes(['hide-nav' => true]); ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 text-center border-b border-gray-50 border-dashed">
                    ...
                    <p class="text-[10px] text-gray-400 mt-2 font-mono bg-gray-50 inline-block px-2 py-1 rounded">
                        Order ID: <?php echo e($transaksi->order_id_pondok); ?>
                ...
                <div class="p-6">
                    ...
                    <?php if($transaksi->metode_pembayaran == 'virtual_account' && Str::contains($transaksi->bukti_bayar_url, '|')): ?>
                        <?php $mandiriParts = explode('|', $transaksi->bukti_bayar_url); ?>
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-xl font-bold text-gray-800 font-mono"><?php echo e($mandiriParts[0]); ?></span>
                                    
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                                <p class="text-xs text-gray-500 mb-1">Nomor Tagihan (Bill Key)</p>
                                <p class="text-2xl font-bold text-emerald-600 font-mono tracking-wider"><?php echo e($mandiriParts[1]); ?></p>
                            </div>
                        </div>

                    
                    <?php elseif($transaksi->metode_pembayaran == 'virtual_account'): ?>
                        <div class="text-center mb-6">
                        ...
                        <div class="bg-emerald-50 p-5 rounded-xl border border-emerald-100 text-center relative">
                            ...
                            <p class="text-3xl font-bold text-gray-800 font-mono tracking-wide break-all" id="va-number">
                                <?php echo e($transaksi->bukti_bayar_url); ?>

                            </p>

                            
                            <button @click="navigator.clipboard.writeText('<?php echo e($transaksi->bukti_bayar_url); ?>'); copied = true; setTimeout(() => copied = false, 2000)" 
                    ...
                    <?php elseif($transaksi->metode_pembayaran == 'qris'): ?>
                        <div class="text-center">
                            ...
                            <div class="inline-block p-4 bg-white border-2 border-gray-100 rounded-2xl shadow-sm">
                                <img src="<?php echo e($transaksi->bukti_bayar_url); ?>" alt="QRIS Code" class="w-64 h-64 object-contain">
                            </div>
                    ...
                    <?php elseif($transaksi->metode_pembayaran == 'gopay'): ?>
                        <div class="text-center py-4">
                            ...
                            <a href="<?php echo e($transaksi->bukti_bayar_url); ?>" class="inline-flex items-center justify-center px-6 py-3.5 bg-sky-600 text-white font-bold rounded-xl shadow-lg shadow-sky-200 hover:bg-sky-700 transition w-full">
                                Buka Aplikasi Gojek
                            </a>
                        </div>
                    <?php endif; ?>
    ...
    <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 pb-6 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] z-50">
        <div class="max-w-3xl mx-auto">
            ...
            <a href="<?php echo e($backUrl); ?>" class="w-full block bg-gray-100 text-gray-600 font-bold text-sm text-center py-3.5 px-6 rounded-xl hover:bg-gray-200 transition">
    ...
    <script>
        if (typeof Swal !== 'undefined') {
            const checkStatusUrl = "<?php echo e(route('orangtua.pembayaran.status', $transaksi->id)); ?>";
            
            const redirectUrl = <?php if($transaksi->tagihan_id): ?>
                "<?php echo e(route('orangtua.tagihan.show', $transaksi->tagihan_id)); ?>";
            <?php else: ?>
                "<?php echo e(route('orangtua.dompet.index')); ?>";
            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/orangtua/payment/instruksi.blade.php ENDPATH**/ ?>