...
<script>
    ...
    const fetchUrl = "<?php echo e(route('sekolah.admin.konfigurasi.kios.new_kode')); ?>"; // Pastikan route ini mengembalikan JSON {kode: '123456'}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.kios', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\keuangan-pesantren\resources\views/sekolah/admin/konfigurasi/kios-kode.blade.php ENDPATH**/ ?>