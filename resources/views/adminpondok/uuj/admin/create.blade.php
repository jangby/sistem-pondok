        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
                ...
                <div class="px-8 py-5 border-b border-gray-100 bg-gray-50">
                    <h2 class="text-xl font-bold text-gray-800">Tambah Akun Admin UJ</h2>
                    <p class="text-sm text-gray-500">Buat akun baru untuk petugas kasir atau pengelola kantin.</p>
                </div>

                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('adminpondok.uuj.admin.store') }}">
                        @csrf
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                                    <p class="text-xs text-yellow-800">
                                        <strong>Info:</strong> Akun ini hanya akan memiliki akses ke modul Uang Jajan dan POS Kasir. Tidak bisa mengakses data santri utama atau keuangan SPP.
                                    </p>
                                </div>
                            </div>
