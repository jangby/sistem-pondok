        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
                ...
                <div class="px-8 py-5 border-b border-gray-100 bg-gray-50">
                    <h2 class="text-xl font-bold text-gray-800">Edit Akun Bendahara</h2>
                    <p class="text-sm text-gray-500">Perbarui data staf atau reset password login.</p>
                </div>

                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('adminpondok.bendahara.update', $bendaharaUser->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $bendaharaUser->name)" required autofocus />
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $bendaharaUser->email)" required />
