        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
                ...
                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('adminpondok.kelas.update', $kelas->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="tingkat" class="block mt-1 w-full" type="text" name="tingkat" :value="old('tingkat', $kelas->tingkat)" />
