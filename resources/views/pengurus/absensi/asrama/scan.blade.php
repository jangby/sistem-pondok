<x-app-layout hide-nav>
    ...
    <div class="min-h-screen bg-gray-900 flex flex-col p-5 font-sans relative overflow-hidden" x-data="scannerApp()">
        ...
        <div class="flex justify-between items-center mb-8 relative z-10">
            ...
            <a href="{{ route('pengurus.absensi.asrama') }}" class="bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-xl text-gray-400 text-xs font-bold border border-gray-700 hover:bg-gray-800 hover:text-white transition">
                Selesai
            </a>
        </div>
    ...
    {{-- LOGIC SCRIPT (Sama, hanya warna visual yang berubah) --}}
    <script>
        function scannerApp() {
            return {
                queue: [],
                ...
                async processQueue() {
                    ...
                    try {
                        const response = await axios.post('{{ route('pengurus.absensi.asrama.process') }}', {
                            rfid: item.code
                        });
