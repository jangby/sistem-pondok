<x-app-layout hide-nav>
    ...
    {{-- Alpine Data: showStats (Grafik), showList (Daftar Nama) --}}
    <div class="min-h-screen bg-gray-50 pb-28" 
        ...
        <div class="bg-emerald-600 pt-8 pb-24 px-6 rounded-b-[35px] shadow-lg relative overflow-hidden z-10">
            <div class="relative z-10 flex justify-between items-center">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('pengurus.absensi.asrama.settings') }}" class="bg-white/20 p-2.5 rounded-xl text-white backdrop-blur-md hover:bg-white/30 transition active:scale-95">
        ...
        <div class="px-6 mt-8 space-y-4">
            ...
            <a href="{{ route('pengurus.absensi.asrama.rekap') }}" class="w-full bg-white border border-gray-200 text-gray-700 font-bold py-4 rounded-2xl shadow-sm hover:bg-gray-50 transition active:scale-95 flex items-center justify-center gap-3">
            ...
            <a href="{{ route('pengurus.absensi.asrama.scan') }}" class="flex flex-col items-center justify-center w-full bg-emerald-600 text-white font-bold py-6 rounded-3xl shadow-xl shadow-emerald-300 hover:bg-emerald-700 transition active:scale-95 relative overflow-hidden border border-emerald-500 mt-2">
        ...
        <div x-show="showList" class="fixed inset-0 z-50 flex items-end justify-center sm:items-center" style="display: none;">
            ...
            <div class="bg-white w-full max-w-md rounded-t-[30px] sm:rounded-3xl relative z-10 shadow-2xl transform transition-transform max-h-[80vh] flex flex-col"
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-2 min-h-[300px]">
                    ...
                    {{-- Logic Loop Data via Alpine & Blade --}}
                    {{-- Kita inject data PHP ke JS agar Alpine bisa render dinamis --}}
                    <script>
                        const santriData = @json($detailSantri);
                    </script>
        ...
        {{-- MODAL GRAFIK (Sama seperti sebelumnya) --}}
