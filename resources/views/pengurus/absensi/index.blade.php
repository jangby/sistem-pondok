<x-app-layout hide-nav>
    ...
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        <div class="px-5 -mt-12 relative z-20">
            ...
            {{-- Menu Tambahan Baru: Jadwal Jaga Gerbang --}}
            <a href="{{ route('pengurus.jadwal.index') }}" class="block bg-white p-5 rounded-2xl shadow-md border border-gray-100 mb-4 group active:scale-95 transition relative overflow-hidden">
