<x-app-layout hide-nav>
    ...
    <div class="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <div class="w-full max-w-md relative z-10 text-center">
            ...
            <p class="text-gray-400 mb-8 text-sm">Tempelkan kartu RFID atau Scan QR Code untuk mencatat kesehatan.</p>

            {{-- FORM INPUT SCAN (Hidden/Auto-Focus) --}}
            <form action="{{ route('pengurus.uks.process-scan') }}" method="POST" class="w-full">
                @csrf
                <div class="relative">
