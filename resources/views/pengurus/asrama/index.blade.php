<x-app-layout hide-nav>
    ...
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        <div class="bg-emerald-600 pt-8 pb-20 px-6 rounded-b-[35px] shadow-lg">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    {{-- Tombol Cetak PDF --}}
                    <a href="{{ route('pengurus.asrama.pdf.data') }}" target="_blank" class="bg-white/20 p-2 rounded-xl text-white backdrop-blur-md hover:bg-white/30 transition" title="Cetak Data Asrama">
        ...
        <div class="px-5 -mt-12 space-y-4 relative z-10">
            ...
            {{-- Menu Asrama Putra --}}
            <a href="{{ route('pengurus.asrama.list', 'Putra') }}" class="block bg-white p-6 rounded-3xl shadow-lg border border-gray-100 active:scale-95 transition group">
            ...
            {{-- Menu Asrama Putri --}}
            <a href="{{ route('pengurus.asrama.list', 'Putri') }}" class="block bg-white p-6 rounded-3xl shadow-lg border border-gray-100 active:scale-95 transition group">
                <div class="flex items-center gap-4">
            ...
            {{-- MENU BARU: Absensi Ketua --}}
            <a href="{{ route('pengurus.asrama.ketua.index') }}" class="block bg-white p-6 rounded-3xl shadow-lg border border-gray-100 active:scale-95 transition group">
                <div class="flex items-center gap-4">
