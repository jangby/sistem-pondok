                ...
                <form action="{{ route('ustadz.ujian.nilai', $jadwal->id) }}" method="POST">
                    ...
                    <div class="bg-emerald-50 border border-emerald-100 p-4 rounded-xl flex items-center justify-between mb-4 mt-2">
                        ...
                        <div class="flex flex-col items-end">
                             <input type="number" name="total_meetings" value="{{ $totalPertemuan }}" 
                        ...
                        @foreach($santris as $santri)
                            ...
                            <div class="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex items-center justify-between gap-3">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    {{-- Input Kehadiran (HANYA JIKA TULIS) --}}
                                    @if(strtolower($jadwal->kategori_tes) == 'tulis')
                                    <div class="flex flex-col items-center">
                                        <input type="number" name="attendance_count[{{ $santri->id }}]" value="{{ $valHadir }}" 
            ...
            <div x-show="tab === 'absensi'" x-transition style="display: none;">
                <form action="{{ route('ustadz.ujian.absensi', $jadwal->id) }}" method="POST">
                    ...
                    <div class="space-y-3 pb-20">
                        ...
                        @foreach($santris as $santri)
                            @php $status = $absensi[$santri->id] ?? 'H'; @endphp 
