<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Desain Template Kartu Ujian') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 flex justify-end">
                <a href="{{ route('pendidikan.admin.kartu-template.create') }}" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('pendidikan.admin.kartu-template.edit', $template->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                    <form action="{{ route('pendidikan.admin.kartu-template.destroy', $template->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Hapus template ini?');">
                                        @csrf @method('DELETE')
