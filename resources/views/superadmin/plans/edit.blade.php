        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
                ...
                <div class="px-8 py-5 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-gray-800">Edit Paket: {{ $plan->name }}</h2>
                        <p class="text-xs text-gray-500 mt-0.5">Perbarui nama atau harga paket.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('superadmin.plans.update', $plan->id) }}">
                        ...
                        <div class="max-w-3xl">
                            <div class="mb-6">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full text-lg" type="text" name="name" :value="old('name', $plan->name)" required autofocus />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <x-text-input id="price_monthly" class="block w-full pl-10" type="number" name="price_monthly" :value="old('price_monthly', $plan->price_monthly)" required />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <x-text-input id="price_yearly" class="block w-full pl-10" type="number" name="price_yearly" :value="old('price_yearly', $plan->price_yearly)" required />
                                    </div>
