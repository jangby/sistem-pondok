...
@section('content')
    {{-- HERO SECTION (ENTERPRISE STYLE WITH BACKGROUND IMAGE) --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full mt-20">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-col sm:flex-row gap-5">
                    <a href="{{ route('ppdb.register') }}" class="px-8 py-4 text-base font-bold text-slate-900 bg-white rounded-xl hover:bg-slate-100 shadow-[0_0_40px_rgba(255,255,255,0.3)] transition transform hover:-translate-y-1 text-center flex items-center justify-center gap-2">
    ...
    {{-- FEATURE/ABOUT SECTION (ASYMMETRICAL MODERN GRID) --}}
    ...
    <section class="py-24 relative overflow-hidden bg-slate-900 mt-10">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('ppdb.register') }}" class="px-10 py-5 bg-emerald-500 text-slate-900 text-lg font-bold rounded-2xl shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:bg-emerald-400 hover:-translate-y-1 transition-all">
