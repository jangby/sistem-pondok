        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('sekolah.superadmin.sekolah.store') }}">
                        @csrf

                        <div>
                            <x-input-label for="nama_sekolah" :value="__('Nama Unit Sekolah')" />
                            <x-text-input id="nama_sekolah" class="block mt-1 w-full" type="text" name="nama_sekolah" :value="old('nama_sekolah')" required autofocus placeholder="Cth: MTS Al-Hidayah" />
