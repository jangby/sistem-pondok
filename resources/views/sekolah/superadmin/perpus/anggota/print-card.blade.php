...
<body onload="window.print()">
    ...
    <div class="card-container">
        ...
        <div class="id-card">
            <div class="bg-pattern"></div>
            {{-- Watermark tipis juga di belakang --}}
            <img src="{{ asset('uploads/logos/logo-pondok.jpg') }}" 
                 onerror="this.src='{{ asset('image_5a2b20.png') }}'"
            ...
            <div class="card-back-content">
                ...
                <div class="signature-area">
                    {{-- Barcode Pindah ke Belakang --}}
                    <div class="barcode-area">
                        <img class="barcode-img-back" 
                             src="https://bwipjs-api.metafloor.com/?bcid=code128&text={{ $santri->nis }}&scale=4&height=14&includetext&textxalign=center&textsize=10" 
