...
<div class="max-w-5xl mx-auto p-6">
    <form action="{{ route('sekolah.superadmin.perpustakaan.sirkulasi.kembali.process', $peminjaman->id) }}" method="POST">
        @csrf
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="border-r border-gray-200 pr-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <span class="font-medium text-lg">{{ $peminjaman->santri->name }}</span>
                        </div>
                        <div>
                            <span class="text-gray-500 text-sm block">Buku</span>
                            <span class="font-medium">{{ $peminjaman->buku->judul }}</span>
                        </div>
                        <div>
                        ...
                        <div class="bg-red-50 p-3 rounded border border-red-200 mt-2">
                            <p class="text-red-800 font-bold">TERLAMBAT: {{ $terlambatHari }} Hari</p>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="denda_keterlambatan" value="{{ $dendaKeterlambatan }}" 
