        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('sekolah.admin.jadwal-pelajaran.store') }}">
                        @csrf
                        ...
                        <div class="mb-4 p-4 bg-gray-100 rounded-lg">
                            ...
                            <span class="text-sm text-gray-600">Semua jadwal yang dibuat akan masuk ke tahun ajaran ini.</span>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <select name="guru_user_id" id="guru_user_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                @foreach($guruList as $guru)
                                    <option value="{{ $guru->id }}" @selected(old('guru_user_id') == $guru->id)>
                                        {{ $guru->name }}
                                    </option>
                                @endforeach
                            </select>
