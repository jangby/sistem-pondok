...
<x-app-layout hide-nav>
    ...
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        {{-- 1. HEADER SECTION (Gaya Orang Tua) --}}
        ...
        {{-- 2. MENU GRID UTAMA (Floating Card Style) --}}
        <div class="px-6 -mt-12 relative z-20">
            <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-50">
                ...
                <div class="grid grid-cols-4 gap-4">
                    {{-- Absen Hadir --}}
                    <a href="{{ route('sekolah.guru.absensi.kehadiran.index') }}" class="flex flex-col items-center gap-2 group">
                    ...
                    {{-- Mengajar --}}
                    <a href="{{ route('sekolah.guru.jadwal.index') }}" class="flex flex-col items-center gap-2 group">
                    ...
                    {{-- Input Nilai --}}
                    <a href="{{ route('sekolah.guru.nilai.index') }}" class="flex flex-col items-center gap-2 group">
        ...
        {{-- 3. JADWAL MENGAJAR HARI INI (List Style instead of Table) --}}
        <div class="px-6 mt-8">
