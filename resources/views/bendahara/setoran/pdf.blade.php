    ...
    <div class="container">
            ...
            <table width="100%" style="border: none;">
                <tr style="background: transparent;">
                    ...
                    <td style="border: none; text-align: right;">
                        <p><strong>Penyetor (Admin Pondok):</strong> {{ $setoran->admin->name ?? '-' }}</p>
                        <p><strong>Penerima (Bendahara):</strong> {{ $setoran->bendaharaPenerima->name ?? '-' }}</p>
        ...
        <div class="clearfix">
            <div class="col-half" style="margin-right: 2%;">
                <h4 style="margin: 5px 0; text-align: center; background: #eee; padding: 5px; border: 1px solid #ddd;">Santri Putra</h4>
                <table>
                    <thead>
                        <tr>
                            <th>Nama / Rincian</th>
            ...
            <div class="col-half">
                <h4 style="margin: 5px 0; text-align: center; background: #eee; padding: 5px; border: 1px solid #ddd;">Santri Putri</h4>
                <table>
                    <thead>
                        <tr>
                            <th>Nama / Rincian</th>
        ...
        <div class="signature-box">
            <p>Diterima Oleh,<br>Bendahara</p>
            <div class="signature-line"></div>
            <p>{{ $setoran->bendaharaPenerima->name ?? '( .................................... )' }}</p>
        </div>
    </div>
</body>
</html>